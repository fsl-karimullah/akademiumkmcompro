      ...
      {currentPath === "/" ? (
        <div className="flex flex-col items-center justify-center md:flex-row relative">
          ...
          <div className="w-full md:w-1/2 flex flex-col text-center md:text-left gap-6 md:gap-8">
            ...
            <span className="md:w-[70%] text-[var(--gray)] font-semibold text-sm md:text-lg">Misi kami adalah memberikan jalan kepada pebisnis dan pengguna untuk saling berinteraksi dan sebagai bentuk dukungan kami kepada produk lokal indonesia</span>
            <div>
        ...
        <div className="relative w-full h-[600px]">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('loginbisnis.jpg')" }}></div>
          ...
          <div className="absolute w-full md:w-1/2 text-center inset-0 flex flex-col items-center md:items-start justify-center md:text-start gap-10 md:gap-4 p-10 text-white">
            ...
            <a target="blank" href="https://ukm.sixeyestech.com/admin/login" className="btn font-bold">Pasang Bisnis Gratis</a>
          </div>
        </div>
      )}
    </div>
