      ...
      {currentPath === "/" ? (
        ...
        <div className="relative w-full h-[600px]">
          ...
          <div className="absolute w-full md:w-1/2 text-center inset-0 flex flex-col items-center md:items-start justify-center md:text-start gap-10 md:gap-4 p-10 text-white">
            ...
            <span className="md:text-xl font-light">Pasang lowongan kerja di KitaLulus gratis! Jangkau lebih dari 3 juta pencari kerja & kandidat terbaik akan menghubungi Anda!</span>
