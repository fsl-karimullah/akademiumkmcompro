...
const menuGroups = [
  { label: "Beranda", path: "/", single: true },
  {
    ...
    children: [
      ...
      { name: "Analisis Finansial", path: "/analisis-keuangan", desc: "Analisis mutasi & kas dengan AI", icon: "📊" },
    ...
    children: [
      {
        name: "Event",
        path: "/event",
        desc: "Workshop, seminar & networking",
        icon: "📅",
      },
      {
        name: "UMKM Showcase",
        path: "/umkm-showcase",
        desc: "Direktori bisnis digital Indonesia",
        icon: "🏪",
      },
      {
        name: "Artikel",
        path: "/allnews",
        desc: "Tips & insight bisnis terkini",
        icon: "📰",
      },
      {
        name: "Cari Kerjasama",
        path: "/partners",
        desc: "Ekosistem Akademi UMKM",
        icon: "🤝",
      },
    ],
  },
    ...
    ? createPortal(
        <>
          ...
          >
            ...
            >
              <span
                style={{ fontWeight: 800, fontSize: "1rem", color: "#1a1a2e" }}
              >
                Menu
              </span>
              <button
            ...
            <div style={{ padding: "10px 12px", flex: 1 }}>
              {allMenuItems.map((item) => {
                const active = isToActive(item.path);
                return (
                  <Link
                    key={item.path}
                    to={item.path}
      ...
      >
        ...
        >
          ...
          >
            ...
            {!isMobile && (
              <span
                style={{ fontWeight: 800, fontSize: "1rem", color: "#d61355" }}
              >
                Akademi UMKM
              </span>
            )}
                ...
                group.single ? (
                  <Link
                    ...
                    style={{
                      ...
                      fontSize: "0.875rem",
                      fontWeight: 600,
                      color: isToActive(group.path) ? "#d61355" : "#4b5563",
                      background: isToActive(group.path)
                        ? "#fff0f4"
                        : "transparent",
                      textDecoration: "none",
                      whiteSpace: "nowrap",
                  ...
                  >
                    <button
                      style={{
                        ...
                        fontWeight: 600,
                        color:
                          isGroupActive(group) || activeGroup === group.label
                            ? "#d61355"
                            : "#4b5563",
                        background:
                          isGroupActive(group) || activeGroup === group.label
